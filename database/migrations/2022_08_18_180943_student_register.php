...
class StudentRegister extends Migration
{
    ...
    public function up()
    {
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_marital_status', function (
            Blueprint $table
        ) {
        ...
        DB::connection('mysql')
            ...
            ->insert([
                ...
                [
                    'name' => 'Divorced',
                    'description' =>
                        'This category includes persons who have obtained a legal divorce and have not remarried. Those who live with a common-law partner are included in this category.',
                    'position' => $position++,
                    'created' => $unixTimeStamp,
                    'register_by' => 1,
                    'modified' => $unixTimeStamp,
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_family_relationship', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
            $table->string('name', 99);
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_single_category', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
            $table->string('name', 99);
        ...
        Schema::connection('mysql')->create('_z_single_data', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::connection('mysql')->table('_z_single_data', function (
            Blueprint $table
        ) {
            $table
                ->foreign('single_category_id')
                ->references('id')
                ->on('_z_single_category');
        });
        $position = 1;
        DB::connection('mysql')
            ->table('_z_single_data')
            ->insert([
                [
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_country', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
        ...
        DB::connection('mysql')
            ...
            ->insert([
                ...
                [
                    ...
                    'dname' => 'British Indian Ocean Territory',
                    'iso3' => 'IO',
                    'numcode' => 0,
                    'phonecode' => 246,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Central African Republic',
                    'iso3' => 'CAF',
                    'numcode' => 140,
                    'phonecode' => 236,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Falkland Islands (Malvinas)',
                    'iso3' => 'FLK',
                    'numcode' => 238,
                    'phonecode' => 500,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'French Southern Territories',
                    'iso3' => 'TF',
                    'numcode' => 0,
                    'phonecode' => 0,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Heard Island and Mcdonald Islands',
                    'iso3' => 'HM',
                    'numcode' => 0,
                    'phonecode' => 0,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Holy See (Vatican City State)',
                    'iso3' => 'VAT',
                    'numcode' => 336,
                    'phonecode' => 39,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Lao Peoples Democratic Republic',
                    'iso3' => 'LAO',
                    'numcode' => 418,
                    'phonecode' => 856,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Northern Mariana Islands',
                    'iso3' => 'MNP',
                    'numcode' => 580,
                    'phonecode' => 1670,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Saint Pierre and Miquelon',
                    'iso3' => 'SPM',
                    'numcode' => 666,
                    'phonecode' => 508,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Saint Vincent and the Grenadines',
                    'iso3' => 'VCT',
                    'numcode' => 670,
                    'phonecode' => 1784,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'South Georgia and the South Sandwich Islands',
                    'iso3' => 'GS',
                    'numcode' => 0,
                    'phonecode' => 0,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'Turks and Caicos Islands',
                    'iso3' => 'TCA',
                    'numcode' => 796,
                    'phonecode' => 1649,
                    'position' => $position++,
                ...
                [
                    ...
                    'dname' => 'United States Minor Outlying Islands',
                    'iso3' => 'UM',
                    'numcode' => 0,
                    'phonecode' => 1,
                    'position' => $position++,
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_country_province', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::connection('mysql')->table('_z_country_province', function (
            Blueprint $table
        ) {
            $table
                ->foreign('country_id')
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_country_city', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::connection('mysql')->table('_z_country_city', function (
            Blueprint $table
        ) {
            $table
                ->foreign('province_id')
                ->references('id')
                ->on('_z_country_province');
        });
        $position = 1;
        DB::connection('mysql')
            ->table('_z_country_city')
            ->insert([
                [
                    'province_id' => 1,
                    'name' => 'Unknown',
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_country_region', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::connection('mysql')->table('_z_country_region', function (
            Blueprint $table
        ) {
            $table
                ->foreign('city_id')
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_country_subregion', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::connection('mysql')->table('_z_country_subregion', function (
            Blueprint $table
        ) {
            $table
                ->foreign('region_id')
                ->references('id')
                ->on('_z_country_region');
        });
        $position = 1;
        DB::connection('mysql')
            ->table('_z_country_subregion')
            ->insert([
                [
                    'region_id' => 1,
                    'name' => 'Unknown',
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_address_type', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
            $table->string('name', 99);
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_address', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::connection('mysql')->table('_z_address', function (
            Blueprint $table
        ) {
            $table
                ->foreign('country_id')
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_qualification', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
            $table
        ...
        Schema::connection('mysql')->table('_z_qualification', function (
            Blueprint $table
        ) {
            $table
                ->foreign('level_id')
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('_z_work_detail', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
            $table
        ...
        Schema::connection('mysql')->table('_z_work_detail', function (
            Blueprint $table
        ) {
            $table
                ->foreign('address_id')
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('student_family_id', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
            $table
        ...
        Schema::connection('mysql')->table('student_family_id', function (
            Blueprint $table
        ) {
            $table
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('student_family', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
        ...
        Schema::connection('mysql')->table('student_family', function (
            Blueprint $table
        ) {
            $table
                ->foreign('relationship_id')
                ->references('id')
                ->on('_z_family_relationship');
            $table
                ->foreign('marital_status_id')
                ->references('id')
                ->on('_z_marital_status');
            $table
                ->foreign('family_id')
                ->references('id')
                ->on('student_family_id');
            $table
        ...
        |--------------------------------------------------------------------------
        */
        Schema::connection('mysql')->create('student_register', function (
            Blueprint $table
        ) {
            $table->increments('id', true)->unsigned();
            $table
        ...
        Schema::connection('mysql')->table('student_register', function (
            Blueprint $table
        ) {
            $table
                ->foreign('family_id')
        ...
        */
        ...
        DB::connection('mysql')
            ->table('student_emergency_contact')
            ->insert([
                [
                    'name' => 'Atif Naseem',
                    'family_id' => 1,
        ...
        */
        ...
        Schema::connection('mysql')->table('student_academic_record', function (
            Blueprint $table
        ) {
            $table
                ->foreign('student_id')
